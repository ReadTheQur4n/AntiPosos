...
namespace ImGui
{
    ...
    // - Set io.IniFilename to NULL to _load/save manually. Read io.WantSaveIniSettings description about handling .ini saving manually.
...
enum ImGuiWindowFlags_
{
    ...
    ImGuiWindowFlags_NoSavedSettings        = 1 << 8,   // Never _load/save settings in .ini file
...
struct ImGuiIO
{
    ...
    ImFontAtlas*Fonts;                          // <auto>           // Font atlas: _load, rasterize and pack one or more fonts into a single texture.
    ...
    bool        WantSaveIniSettings;                // When manual .ini _load/save is active (io.IniFilename == NULL), this will be set to notify your application that you can call SaveIniSettingsToMemory() and save yourself. Important: clear io.WantSaveIniSettings yourself after saving!
