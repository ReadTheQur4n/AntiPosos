...
//  2024-01-09: OpenGL: Update GL3W based imgui_impl_opengl3_loader.h to _load "libGL.so" and variants, fixing regression on distros missing a symlink.
//  2023-11-08: OpenGL: Update GL3W based imgui_impl_opengl3_loader.h to _load "libGL.so" instead of "libGL.so.1", accommodating for NetBSD systems having only "libGL.so.3" available. (#6983)
...
// Modern desktop OpenGL doesn't have a standard portable header file to _load OpenGL function pointers.
